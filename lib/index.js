...
GLSL.prototype.compile = function compile (arg) {
	...
	if (result.indexOf(".swizzle") >= 0) {
		...
		pre_functions += "Float32Array.prototype.swizzle = function(positions) { var _this = this; return positions.map(function (x, i) { return this[x]}, _this) }\n"
	}
	...
	result = '/'.repeat(20) + " Start Includes " + '/'.repeat(20) + "\n\n" + pre_functions + '\n\n' + result
...
GLSL.prototype.transforms = {
	...
	stmt: function (node) {
		...
		return Descriptor(result, null, node);
	},
