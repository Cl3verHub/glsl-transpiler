...
GLSL.prototype.compile = function compile (arg) {
	...
	var swizzle_func = "Array.prototype.swizzle = function(positions) { var _this = this; return positions.map(function (x, i) { return this[x]}, _this) }\n"
	result = swizzle_func + result
...
GLSL.prototype.unswizzle = function (node) {
	...
	var result = Descriptor(`(${ident}).swizzle([${positions.join(', ')}])`, {
